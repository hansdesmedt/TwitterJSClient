...
Twitter.prototype.updateProfilePicture = function (params, error, success) {
    var path = '/account/update_profile_image.json';
    var url = this.baseUrl + path;

    var body = "image=" + params["image"];
    //console.log(body);
    this.oauth.post(url, this.accessToken, this.accessTokenSecret, params, null, function (err, body, response) {
...
Twitter.prototype.updateBackgroundPicture = function (params, error, success) {
...
Twitter.prototype.updateProfileBanner= function (params, error, success) {
    var path = '/account/update_profile_banner.json';
    var url = this.baseUrl + path;

    var body = "banner=" + params["image"];
    //console.log(body);
    this.oauth.post(url, this.accessToken, this.accessTokenSecret, params, null, function (err, body, response) {
...
Twitter.prototype.getTrendsForPlace = function (params, error, success) {
...
Twitter.prototype.postUpdate = function(params, error, success)  {
